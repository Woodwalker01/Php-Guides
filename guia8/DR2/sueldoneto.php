...
$prestamo = (isset($_POST['numhorasex'])) ?
floatval($_POST['numhorasex']) : 0.0;
//Creando instancias de la clase empleado
$empleado1 = new empleado();
$empleado1->obtenerSalarioNeto($name, $apellido,
$sueldo, $numHorasExtras, $pagohoraextra,$prestamo);
}
}
else{
?>
...
method="POST" name="salario" id="salario">
<fieldset>
...
<div class="element-checkbox">
    <label class="title">Prestamos:</label>
...
<div class="element-number">
    ...
    <div class="item-cont">
        <input type="text" name="numhorasex" id="numhorasex" maxlength="3" 
disabled="disabled" placeholder="Cantidad de prestamo" allowed="0123456789" 
