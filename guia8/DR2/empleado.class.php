<?php
 ...
 function __construct(){
   ...
   $horasextras, $pagoxhoraextra=0.0,$prestamo=0.0){
    $this->nombre = $nombre;
   ...
   + $this->afp);
    ...
    //el descuento de la renta varía según el ingresopercibido
...
$this->pagoxhoraextra - ($this->isss + $this->afp + $this->renta+$this->prestamo);
...
',') . "</td></tr>";
$tabla .= "<tr><td>Cantidad de prestamo a pagar: </td>";
