...
if(isset($_POST['btnContar'])):
 ...
 echo "<p>Se han contabilizado: " . count($textolimpio)-2 . "$complemento</p>\n";

echo json_encode($textolimpio);
else:
?>
...
<textarea name="area" id="text-box"
...
<![endif]-->
<script
src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.js"></scr
ipt>
<script
