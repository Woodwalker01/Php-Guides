...
$db->set_charset("utf8");
 ...
 $consulta = "SELECT * FROM Productos WHERE ". $tema;
 $consulta .= " = '" . $termino . "'";
 } else {
...
$consulta . "</p>\n\t";
 ...
 echo "<p>Número de Productos encontrados: .
$num_results</p>\n</div>\n";
...
bg-info'>Libro " . ($i + 1) . "</div>";
 echo "<div class='card-body'>";
 echo" <ul class='list-group
list-group-flush'>";
 echo"<li class='list-group-item'>Título "
. ($i + 1) . ":".stripslashes($row['nombreproducto'])."</li>";
 echo"<li class='list-group-item'>Autor
:".stripslashes($row['categoria'])."</li>";
 echo"<li class='list-group-item'>ISBN
 :".stripslashes($row['Existencia'])."</li>";
...
text-small">Menu</small>
 ...
 <a href="busquedalibro.html"
class="d-block h3 font-weight-normal">
 Realizar<br>
 <small class="d-block text-muted
text-small">Otra busqueda</small>
 </a>
 </div>
 </div>
</section>
